...
public class ReviewCssExtractorFromJsp {
    ...
    public static void main(String[] args) {
        String jspFileUrl = "https://doberman-ready-termite.ngrok-free.app/recruit-app/review/reviewResult.jsp";  // JSP ���� URL (���� ��� ����)
        String outputDirectory = "C:/dev/recruit-app/src/main/webapp/assets/css/review";// �ƿ�ǲ ���� ���� ��� (���� �ʿ�)
        String updatedJspFilePath = "C:/dev/recruit-app/src/main/webapp/main/reviewResult_updated.jsp"; // ������Ʈ ���� ���� ���+ ����� ���� (���� �ʿ�)
        String baseUrl = "https://doberman-ready-termite.ngrok-free.app/recruit-app/assets/css/review/"; //CSS ���ϳ��� ���ҽ� ������ ��� ��θ� ���� ��η� ������ �� ���Ǵ� �⺻ URL
        //(CSS ���� ���� ��ο� ���ƾ� ��)
