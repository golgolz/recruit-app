...
<div class="company-header-container">
    <div class="company-header-branding background-type4">
        <div class="company-header-branding-container ">
            ...
            <div class="logo">
                <img src="https://doberman-ready-termite.ngrok-free.app/recruit-app/assets/images/company/logo/<c:out value="${ companyInfo.companyImg }"/>" style="width:100px; height:auto;">
