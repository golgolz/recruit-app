...
<script type="text/javascript">
		$(function(){
			...
			$('#signupBtn').click(function(){
				location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/user/signupPage.do';
			});
										...
										<form class="css-e130a2" action="../user/login.do" id="loginFrm" method="post">
											...
											<div class="css-z0tt1n">
												...
												<div class="button-group" style="margin-bottom: 80px;">
													<button type="button" class="css-1akojk6" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/user/signupPage.do'">
														<span data-testid="Typography" color="#000000"
															class="css-kfktv3">
															<a href="https://doberman-ready-termite.ngrok-free.app/recruit-app/user/signupPage.do">회원가입</a></span>
													</button>
													<button type="button" data-testid="Button"
														class="css-zzrlz5">
														<span data-testid="Typography" color="#000000"
															class="css-1nosfqs">
															<a href="https://doberman-ready-termite.ngrok-free.app/recruit-app/user/findMail.do">계정 찾기</a></span>
													</button>
													<button type="button" data-testid="Button"
														class="css-zzrlz5">
														<span data-testid="Typography" color="#000000"
															class="css-1nosfqs">
															<a href="https://doberman-ready-termite.ngrok-free.app/recruit-app/user/findPass.do">비밀번호 찾기</a></span>
													</button>
												</div>
											</div>
										</form>
