		...
		<ul class="navbar-nav">
			...
			<li class="nav-item">
				<a 
					id="recruit_menu"
					class="nav-link text-white"
					href="https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/recruits.do">
			...
			<li class="nav-item">
				<a
					id="review_menu"
					class="nav-link text-white"
					href="https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/review/review.do">
