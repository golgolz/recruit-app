...
<div class="ec-base-button ">
            <span class="gRight">
            	<input type="button" value="등록" class="btn btn-outline-success btn-sm float-right" id="btnWrite" name="btnWrite" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/notice/notices.do'"/><!-- noticesInsert -->
            	<input type="button" value="취소" class="btn btn-outline-dark btn-sm detail-control" id="btnCancel" name="btnCancel" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/notice/notices.do'"/>
            </span>
        </div>
</div>
</div>
