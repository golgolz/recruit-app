			...
			<div>
				<div class="loungeContent noticeViewContent" id="notice_detail_view">
			        <div class="noticeViewWrap">
			            ...
			            <div>
			                <input type="button" class="btn btn-outline-dark btn-sm detail-control" value="뒤로" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/notice/notices.jsp'">
			                <input type="button" class="btn btn-outline-warning btn-sm" value="수정" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/notice/notices_update.jsp'">
			                <input type="button" class="btn btn-outline-danger btn-sm" value="삭제" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/notice/notices.jsp'">
			            </div>
			        </div>
			    </div>
			</div>
