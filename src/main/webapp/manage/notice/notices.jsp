					...
					<table id="sodr_list">
						...
						<tbody>
							<tr class="list0">
								...
								<td>2024.03.19</td>
								<td>
									<input type="button" value="바로가기" class="btn btn-outline-secondary btn-sm" style="font-weight: bold; margin: 0px auto;" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/notice/notices_detail.jsp'"/>
								</td>
							</tr>
							<tr class="list0">
								<td>2</td>
					...
					<table cellpadding="0" cellspacing="0" border="0" width="100%">
						<tbody>
							<tr>
								...
								<td align="right">
									<input type="button" value="등록하기" class="btn btn-outline-success btn-sm float-right" style="font-weight: bold; margin: 10px auto;" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/notice/notices_write.jsp'" />
								</td>
							</tr>
						</tbody>
					</table>
