...
<div class="ec-base-button ">
            <span class="gRight">
            	<input type="button" value="수정" class="btn btn-outline-warning btn-sm" id="btnWrite" name="btnWrite" onclick="location.href='https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/notice/notices.jsp'"/>
