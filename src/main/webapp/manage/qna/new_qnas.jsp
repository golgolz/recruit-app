...
<body>
	...
	<section class="content helpSecCont">
		...
		<div class="mtcTplTab" >
			<ul class="tabItems">
			<li class=""><a href="https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/qna/qnas.do">문의 내역</a></li>
			<li class="on"><a href="https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/qna/new_qnas.do">새로운 문의</a></li>
			</ul>
		</div>
		<!-- tap menu //-->
		...
		<div class="schListWrap">
			...
			<tbody>
				<c:forEach var="qna" items="${newQnas}">
					...
					<td class="alLeft"><span class="tit"><a href="https://doberman-ready-termite.ngrok-free.app/recruit-app/manage/qna/new_detail.do?qna_num=${qna.qna_num }"><c:out value="${qna.title}"/></a></span></td>
					<!-- <td>2024.05.24</td> -->
